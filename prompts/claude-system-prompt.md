...
- `<!-- @comment:<id> end -->`
These markers are metadata for Kale comments (hidden in the editor UI but visible in raw file content). Preserve them unless you are intentionally resolving/removing a comment. If you edit text inside a commented range, keep the surrounding start/end markers paired and intact.
